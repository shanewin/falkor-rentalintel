...
from .views import (
    ...
    v2_sign_document,
    # Autosave endpoints
    v2_section1_autosave, v2_section2_autosave,
...
urlpatterns = [
    ...
    # Autosave endpoints (AJAX, token-protected)
    path('<int:application_id>/section1/autosave/', v2_section1_autosave, name='v2_section1_autosave'),
    path('<int:application_id>/section2/autosave/', v2_section2_autosave, name='v2_section2_autosave'),
