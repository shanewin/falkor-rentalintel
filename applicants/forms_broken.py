            ...
            Fieldset(
                ...
                Div(
                    Row(
                        ...
                        Column(Field('current_landlord_phone', placeholder="Landlord's Phone"), css_class='col-md-4'),
                ...
                <div class="mt-3">
                    <label class="form-label">
                        ...
                        <i class="fas fa-question-circle text-muted ms-2" 
                           ...
                           title="Please upload an image for each selected ID type. You can upload multiple files at once.">
                        </i>
                    </label>
                    <div class="id-type-checkboxes">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label fs-5 ms-2" for="id_driver_license" style="padding-top: 2px;">
                                <i class="fas fa-id-card"></i> Driver License
                            </label>
                        </div>
                        <div class="form-check mb-3">
                    ...
                    <div id="passport_upload" class="id-upload-section mt-3" style="display: none;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="file" name="passport_document" accept="image/*" class="form-control">
                                <small class="text-muted">Upload a clear photo of your passport</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="driver_license_upload" class="id-upload-section mt-3" style="display: none;">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-3"><i class="fas fa-id-card"></i> Upload Driver License</h6>
                                <input type="file" name="driver_license_document" accept="image/*" class="form-control">
                                <small class="text-muted">Upload a clear photo of your driver license (front and back)</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="state_id_upload" class="id-upload-section mt-3" style="display: none;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="file" name="state_id_document" accept="image/*" class="form-control">
                                <small class="text-muted">Upload a clear photo of your state ID (front and back)</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-12">
                        <div class="form-check mb-2">
                            <input class="form-check-input pets-checkbox" type="checkbox" id="has_pets" style="width: 1.5em; height: 1.5em; transform: scale(1.2);">
...
class ApplicantEmploymentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'current_employer', 'job_title', 'length_of_employment', 'monthly_income', 'employer_contact_info',
            # Student fields
...
Upload Photo
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cropperModalLabel">
                                        <i class="fas fa-crop"></i> Crop Your Profile Photo
                                    </h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mt-3">
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-outline-primary btn-sm" id="zoom-in">
                                                <i class="fas fa-search-plus"></i> Zoom In
                                            </button>
                                            <button type="button" class="btn btn-outline-primary btn-sm" id="zoom-out">
                                                <i class="fas fa-search-minus"></i> Zoom Out
                                            </button>
                                            <button type="button" class="btn btn-outline-primary btn-sm" id="rotate-left">
                                                <i class="fas fa-undo"></i> Rotate Left
                                            </button>
                                            <button type="button" class="btn btn-outline-primary btn-sm" id="rotate-right">
                                    ...
                                    <div class="mt-3">
                                        <small class="text-muted">
                                            <i class="fas fa-info-circle"></i> 
                                            Drag to move, use corners to resize, scroll to zoom. The result will be a square profile photo.
                                        </small>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="apply-crop">
            ...
            Fieldset(
                'Income & Employment',
                Row(
                    Column('current_employer', css_class='col-md-6'),
                    Column('job_title', css_class='col-md-6'),
                ),
                Row(
                    Column(Field('length_of_employment', placeholder="e.g., 2 years"), css_class='col-md-6'),
                    Column(Field('monthly_income', template='applicants/currency_income_field.html'), css_class='col-md-6'),
                ),
